...
import tp4.tabelaHashEnderecamentoAberto.hashtable.*;
...
public class Main {
	...
	public static void main(String[] args) {
		/*
			Cria uma tabela hash de tamanho 79, com endereçamento aberto e rehashing, e popula a
			tabela com os jogadores indicados pela entrada padrão stdin.
